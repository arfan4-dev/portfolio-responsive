...
const Section = () => {
    return (
        <div className='flex flex-col-reverse items-center mt-20 lg:flex lg:flex-row lg:space-x-72 lg:ml-24 2xl:ml-36  lg:items-center'>
            ...
            <div className='relative mt-24 lg:mt-14 2xl:mt-32  '>
            ...
            <div className='relative w-[]'>
                ...
                <img src="/assets/ARROW.svg" alt="" className='absolute top-[290px] right-[40px] lg:top-[430px] lg:right-[60px] 2xl:top-[430px] 2xl:right-[60px] w-[70px] lg:w-[94px]' />
