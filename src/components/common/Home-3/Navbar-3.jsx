...
import Section from './Section-3';
const Navbar = () => {
    return (
        <div className=''>
            {/* Mobile screen Navbar */}
            <div className='lg:hidden bg-[#28293E] min-h-screen  text-[#FFFFFF] w-[108%] lg:w-[100%]'>
            ...
            < div className={`bg-[#28293E] h-[600px] hidden lg:block  text-[#FFFFFF] `
            }>
