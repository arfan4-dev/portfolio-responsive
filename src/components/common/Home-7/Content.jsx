        ...
        <div className='bg-[#FDF0E9] min-h-screen'>
            ...
            <div className='hidden lg:block lg:space-y-5'>
                ...
                <div className='relative flex justify-center items-center'>
                    <img src="/assets/Bitmap (4).png" alt="" className=' w-[323px] lg:w-[1170px] h-[416px] lg:h-[726px] ' />
                    <div className='absolute bottom-[13px] left-[1.5rem]  lg:bottom-[20px] lg:left-[8rem] 2xl:left-[14rem] '>
                ...
                <div className='flex items-center justify-center space-x-5'>
                    <div className='relative'>
                        <img src="/assets/Bitmap (3).png" alt="" className='w-[323px] lg:w-[570px] h-[416px] ' />
                    ...
                    <div className='relative'>
                        <img src="/assets/Bitmap (4).png" alt="" className=' w-[323px] lg:w-[570px] h-[416px]' />
                        <div className='absolute  bottom-[13px] left-[1.5rem]   lg:bottom-[20px] lg:left-[2rem]'>
                            <button className='bg-[#ffff] text-[#391400] text-[16px] px-4 py-2 rounded-full'>Branding</button>
                ...
                <div className='flex items-center justify-center space-x-5'>
                    <div className='relative'>
                        <img src="/assets/Bitmap (15).png" alt="" className='w-[323px] lg:w-[570px] h-[416px] ' />
                        <div className='absolute  bottom-[13px] left-[1.5rem] lg:bottom-[20px] lg:left-[2rem]'>
            ...
            <div className='py-10 flex justify-center items-center space-x-5'>
                <p className='w-[48px] text-center px-5 py-4 bg-[#EF6D58] text-white text-[14px]'>1</p>
                <p className='w-[48px] text-center px-5 py-4 bg-[#ffff]  text-[14px]'>2</p>
                <p className='w-[48px] text-center px-5 py-4 bg-[#ffff]  text-[14px]'>3</p>
                <p className='w-[48px] text-center px-5 py-4 bg-[#ffff]  text-[14px]'>4</p>
                <p className='w-[48px] text-center px-5 py-4 bg-[#ffff]  text-[14px]'>5</p>
